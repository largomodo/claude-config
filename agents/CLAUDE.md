...
Sub-agent definitions used by the planner and skill workflows.
...
| `technical-writer.md` | LLM-optimized documentation agent               | Modifying doc generation, token budgets          |
